...
function delrow(e) {
    e.preventDefault();
    var remove = itemlist.lastElementChild;
    console.log(remove);
...
function delrow2(e) {
    e.preventDefault();
    var remove = itemlist2.lastElementChild;
    console.log(remove);
...
function delrow3(e) {
    e.preventDefault();
    var remove = itemlist3.lastElementChild;
    console.log(remove);
...
window.onload = function () {
    document.getElementById("generate")
        .addEventListener("click", () => {
            ...
            const container2 = this.document.getElementById("container2");
            ...
            html2pdf().from(container2).set(opt).save();
        })
}